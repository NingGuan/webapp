 ...
 * 
 */
@WebServiceClient(name = "CommonService", targetNamespace = "http://www.guanning.com/", wsdlLocation = "http://localhost:8080/services/CommonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName COMMONSERVICE_QNAME = new QName("http://www.guanning.com/", "CommonService");
    ...
    public CommonService getCommonServiceImpPort() {
        return super.getPort(new QName("http://www.guanning.com/", "CommonServiceImpPort"), CommonService.class);
    }
    ...
    public CommonService getCommonServiceImpPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.guanning.com/", "CommonServiceImpPort"), CommonService.class, features);
    }
